				  ...
				  unsigned int flags)
{
	...
	// my changes
	printk(KERN_INFO "Dir: vfat_lookup\n");
		       ...
		       bool excl)
{
	...
	// my changes
	printk(KERN_INFO "Dir: vfat_create\n");
...
static int vfat_rmdir(struct inode *dir, struct dentry *dentry)
{
	...
	// my changes
	printk(KERN_INFO "Dir: vfat_rmdir\n");
...
static int vfat_unlink(struct inode *dir, struct dentry *dentry)
{
	...
	// my changes
	printk(KERN_INFO "Dir: vfat_unlink\n");
...
static int vfat_mkdir(struct inode *dir, struct dentry *dentry, umode_t mode)
{
	...
	// my changes
	printk(KERN_INFO "Dir: vfat_mkdir\n");
		       ...
		       unsigned int flags)
{
	...
	// my changes
	printk(KERN_INFO "Dir: vfat_rename\n");
