...
found:
	...
	printk(KERN_INFO "DIRECTORY TABLE: fat_search_long\n"
					 "\t\ti_pos = %llu\n"
					 "\t\tslot_off = %llu\n"
					 "\t\tnr_slots = %d\n",
					 sinfo->i_pos,
	...
	sprintf(buf, "DIRECTORY TABLE: fat_search_long\n"
					 "\t\ti_pos = %llu\n"
					 "\t\tslot_off = %llu\n"
					 "\t\tnr_slots = %d\n",
					 sinfo->i_pos,
	     ...
	     struct fat_slot_info *sinfo)
{
	...
	while (fat_get_short_entry(dir, &sinfo->slot_off, &sinfo->bh,
		...
		if (!strncmp(sinfo->de->name, name, MSDOS_NAME)) {
			...
			sinfo->nr_slots = 1;
			sinfo->i_pos = fat_make_i_pos(sb, sinfo->bh, sinfo->de);
			printk(KERN_INFO "DIRECTORY TABLE: fat_scan\n"
					 "\t\ti_pos = %llu\n"
					 "\t\tslot_off = %llu\n"
					 "\t\tnr_slots = %d\n",
					 sinfo->i_pos,
					 sinfo->slot_off,
					 sinfo->nr_slots);
			sprintf(buf, "DIRECTORY TABLE: fat_scan\n"
					 "\t\ti_pos = %llu\n"
					 "\t\tslot_off = %llu\n"
					 "\t\tnr_slots = %d\n",
					 sinfo->i_pos,
		      ...
		      struct fat_slot_info *sinfo)
{
	...
	while (fat_get_short_entry(dir, &sinfo->slot_off, &sinfo->bh,
		...
		if (fat_get_start(MSDOS_SB(sb), sinfo->de) == i_logstart) {
			...
			sinfo->nr_slots = 1;
			sinfo->i_pos = fat_make_i_pos(sb, sinfo->bh, sinfo->de);
			printk(KERN_INFO "DIRECTORY TABLE: fat_scan_logstart\n"
					 "\t\ti_pos = %llu\n"
					 "\t\tslot_off = %llu\n"
					 "\t\tnr_slots = %d\n",
					 sinfo->i_pos,
					 sinfo->slot_off,
					 sinfo->nr_slots);
			sprintf(buf, "DIRECTORY TABLE: fat_scan_logstart\n"
					 "\t\ti_pos = %llu\n"
					 "\t\tslot_off = %llu\n"
					 "\t\tnr_slots = %d\n",
					 sinfo->i_pos,
...
int fat_remove_entries(struct inode *dir, struct fat_slot_info *sinfo)
{
	...
	printk(KERN_INFO "DIRECTORY TABLE: fat_remove_entries\n"
					 "\t\ti_pos = %llu\n"
					 "\t\tslot_off = %llu\n"
					 "\t\tnr_slots = %d\n",
					 sinfo->i_pos,
					 sinfo->slot_off,
					 sinfo->nr_slots);
	sprintf(buf, "DIRECTORY TABLE: fat_remove_entries\n"
					 "\t\ti_pos = %llu\n"
					 "\t\tslot_off = %llu\n"
					 "\t\tnr_slots = %d\n",
					 sinfo->i_pos,
...
found:
	...
	printk(KERN_INFO "DIRECTORY TABLE: fat_add_entries\n"
					 "\t\ti_pos = %llu\n"
					 "\t\tslot_off = %llu\n"
					 "\t\tnr_slots = %d\n",
					 sinfo->i_pos,
	...
	sprintf(buf, "DIRECTORY TABLE: fat_add_entries\n"
					 "\t\ti_pos = %llu\n"
					 "\t\tslot_off = %llu\n"
					 "\t\tnr_slots = %d\n",
					 sinfo->i_pos,
