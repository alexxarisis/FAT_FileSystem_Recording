				   ...
				   unsigned int flags)
{
	...
	// my changes
	printk(KERN_INFO "Dir: msdos_lookup\n");
			...
			bool excl)
{
	...
	// my changes
	printk(KERN_INFO "Dir: msdos_create\n");
...
static int msdos_rmdir(struct inode *dir, struct dentry *dentry)
{
	...
	// my changes
	printk(KERN_INFO "Dir: msdos_rmdir\n");
...
static int msdos_mkdir(struct inode *dir, struct dentry *dentry, umode_t mode)
{
	...
	// my changes
	printk(KERN_INFO "Dir: msdos_mkdir\n");
...
static int msdos_unlink(struct inode *dir, struct dentry *dentry)
{
	...
	// my changes
	printk(KERN_INFO "Dir: msdos_unlink\n");
			...
			unsigned int flags)
{
	...
	// my changes
	printk(KERN_INFO "Dir: msdos_rename\n");
